...
class KategoriScreenAction extends StatelessWidget {
  const KategoriScreenAction({Key? key}) : super(key: key);
          ...
          FutureBuilder<List<dynamic>>(
            ...
            builder: (BuildContext context, AsyncSnapshot snapshot) {
              if (snapshot.hasData) {
               ...
               List<dynamic> filteredData = snapshot.data.where((item) => item.id >= 21 && item.id <= 30).toList();
