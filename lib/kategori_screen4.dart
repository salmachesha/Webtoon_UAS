...
class KategoriScreenComedy extends StatelessWidget {
  const KategoriScreenComedy({Key? key}) : super(key: key);
          ...
          FutureBuilder<List<dynamic>>(
            ...
            builder: (BuildContext context, AsyncSnapshot snapshot) {
              if (snapshot.hasData) {
               ...
               List<dynamic> filteredData = snapshot.data.where((item) => item.id >= 31 && item.id <= 40).toList();
