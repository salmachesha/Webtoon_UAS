...
class KategoriScreenHorror extends StatelessWidget {
  const KategoriScreenHorror({Key? key}) : super(key: key);
            ...
            builder: (BuildContext context, AsyncSnapshot snapshot) {
              if (snapshot.hasData) {
                ...
                List<dynamic> filteredData =
                    snapshot.data.where((item) => item.id >= 1 && item.id <= 10).toList();
